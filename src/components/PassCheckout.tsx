...
export function PassCheckout({product,busy,onBack,onConfirm}:{product:CheckoutProduct;busy:boolean;onBack:()=>void;onConfirm:(method:PaymentMethod)=>void}){
 ...
 return <Modal visible animationType="slide" onRequestClose={()=>{if(!busy)onBack();}}><ScrollView style={styles.page} contentContainerStyle={{padding:24,paddingTop:insets.top+16,paddingBottom:insets.bottom+24}}>
